...
QuicSimpleConnectionHelper::QuicSimpleConnectionHelper(base::TaskRunner* task_runner,
...
QuicSimpleConnectionHelper::~QuicSimpleConnectionHelper() {}

const QuicClock* QuicSimpleConnectionHelper::GetClock() const {
  return clock_;
}

QuicRandom* QuicSimpleConnectionHelper::GetRandomGenerator() {
  return random_generator_;
}

QuicAlarm* QuicSimpleConnectionHelper::CreateAlarm(QuicAlarm::Delegate* delegate) {
  return new QuicChromeAlarm(clock_, task_runner_, delegate);
}

QuicBufferAllocator* QuicSimpleConnectionHelper::GetBufferAllocator() {
