...
QuicServerSimpleSessionBase::QuicServerSimpleSessionBase(
...
void QuicServerSimpleSessionBase::Initialize() {
  crypto_stream_.reset(CreateQuicCryptoServerStream(crypto_config_));
  QuicSimpleSession::Initialize();
}

void QuicServerSimpleSessionBase::OnConfigNegotiated() {
...
void QuicServerSimpleSessionBase::OnConnectionClosed(QuicErrorCode error,
                                               bool from_peer) {
...
void QuicServerSimpleSessionBase::OnWriteBlocked() {
  QuicSession::OnWriteBlocked();
  visitor_->OnWriteBlocked(connection());
}

void QuicServerSimpleSessionBase::OnCongestionWindowChange(QuicTime now) {
...
bool QuicServerSimpleSessionBase::ShouldCreateIncomingDynamicStream(QuicStreamId id) {
...
bool QuicServerSimpleSessionBase::ShouldCreateOutgoingDynamicStream() {
  if (!connection()->connected()) {
...
QuicCryptoServerStreamBase* QuicServerSimpleSessionBase::GetCryptoStream() {
