...
QuicSockPacketReader::QuicSockPacketReader() {
  Initialize();
}

void QuicSockPacketReader::Initialize() {
...
bool QuicSockPacketReader::ReadAndDispatchPackets(
    int fd,
    int port,
...
/* static */
bool QuicSockPacketReader::ReadAndDispatchSinglePacket(
    int fd,
    int port,
    ProcessPacketInterface* processor,
    QuicPacketCount* packets_dropped) {
