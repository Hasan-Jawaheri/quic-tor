...
#ifndef NET_TOOLS_QUIC_QUICSOCK_TIME_WAIT_LIST_MANAGER_H_
#define NET_TOOLS_QUIC_QUICSOCK_TIME_WAIT_LIST_MANAGER_H_
...
namespace test {
class QuicSockTimeWaitListManagerPeer;
}  // namespace test
...
// QuicSockTimeWaitListManager by the QuicDispatcher.  Decides whether to send a
...
// connection_id.
class QuicSockTimeWaitListManager : public QuicBlockedWriterInterface {
 public:
  ...
  QuicSockTimeWaitListManager(QuicPacketWriter* writer,
                          QuicSockServerSessionVisitor* visitor,
                          QuicConnectionHelperInterface* helper);
  ~QuicSockTimeWaitListManager() override;
 ...
 private:
  friend class test::QuicSockTimeWaitListManagerPeer;
  ...
  QuicSockServerSessionVisitor* visitor_;

  DISALLOW_COPY_AND_ASSIGN(QuicSockTimeWaitListManager);
};

}  // namespace tools
}  // namespace net

#endif  // NET_TOOLS_QUIC_QUICSOCK_TIME_WAIT_LIST_MANAGER_H_
