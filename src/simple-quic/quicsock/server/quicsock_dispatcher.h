...
#ifndef _QUICSOCK_DISPATCHER_H_
#define _QUICSOCK_DISPATCHER_H_
...
#include "quicsock/quicsock_process_packet_interface.h"
...
class QuicSockServerSessionBase;

namespace tools {

class QuicSockDispatcher : public QuicSockServerSessionVisitor,
                       public ProcessPacketInterface,
                       public QuicBlockedWriterInterface {
 public:
  // Creates per-connection packet writers out of the QuicSockDispatcher's shared
  ...
  // QuicSockDispatcher::OnCanWrite logic will not work. (This will hopefully be
  ...
  QuicSockDispatcher(const QuicConfig& config,
  ...
  // QuicSockServerSessionVisitor interface implementation:
  ...
  typedef base::hash_map<QuicConnectionId, QuicSockServerSessionBase*> SessionMap;
 ...
 protected:
  virtual QuicSockServerSessionBase* CreateQuicSockSession(
  ...
  virtual QuicSockTimeWaitListManager* CreateQuicSockTimeWaitListManager();
 ...
 private:
  ...
  // writer argument away from QuicSockDispatcher::PacketWriterFactory.
  class PacketWriterFactoryAdapter
      : public QuicConnection::PacketWriterFactory {
   public:
    explicit PacketWriterFactoryAdapter(QuicSockDispatcher* dispatcher);
  ...
  scoped_ptr<QuicSockTimeWaitListManager> time_wait_list_manager_;

  // The list of closed but not-yet-deleted sessions.
  std::vector<QuicSockServerSessionBase*> closed_session_list_;
  ...
  DISALLOW_COPY_AND_ASSIGN(QuicSockDispatcher);
};

}  // namespace tools
}  // namespace net

#endif  // _QUICSOCK_DISPATCHER_H_
