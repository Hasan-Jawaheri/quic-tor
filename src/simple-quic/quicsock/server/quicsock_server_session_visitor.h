...
#ifndef NET_TOOLS_QUIC_QUICSOCK_SERVER_SESSION_VISITOR_H_
#define NET_TOOLS_QUIC_QUICSOCK_SERVER_SESSION_VISITOR_H_
...
class QuicSockServerSessionVisitor {
 public:
  virtual ~QuicSockServerSessionVisitor() {}
...
#endif  // NET_TOOLS_QUIC_QUICSOCK_SERVER_SESSION_VISITOR_H_
