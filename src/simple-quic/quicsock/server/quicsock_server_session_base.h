...
#ifndef _QUICSOCK_SERVER_SESSION_BASE_H_
#define _QUICSOCK_SERVER_SESSION_BASE_H_
...
class QuicSockServerSessionBase : public QuicSockSession {
 public:
  // |crypto_config| must outlive the session.
  QuicSockServerSessionBase(const QuicConfig& config,
                        QuicConnection* connection,
                        QuicSockServerSessionVisitor* visitor,
                        const QuicCryptoServerConfig* crypto_config,
                        quicsock::QuicSockObserver *quicsocker_observer);
  ...
  ~QuicSockServerSessionBase() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(QuicSockServerSessionBase);
};

}  // namespace tools
}  // namespace net

#endif  // _QUICSOCK_SERVER_SESSION_BASE_H_
