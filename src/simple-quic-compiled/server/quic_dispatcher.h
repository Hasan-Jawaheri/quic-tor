...
class QuicServerSimpleSessionBase;
...
class QuicDispatcher : public QuicServerSimpleSessionVisitor,
 ...
 public:
  ...
  // QuicServerSimpleSessionVisitor interface implementation:
  ...
  typedef base::hash_map<QuicConnectionId, QuicServerSimpleSessionBase*> SessionMap;
 ...
 protected:
  virtual QuicServerSimpleSessionBase* CreateQuicSession(
 ...
 private:
  ...
  std::vector<QuicServerSimpleSessionBase*> closed_session_list_;
