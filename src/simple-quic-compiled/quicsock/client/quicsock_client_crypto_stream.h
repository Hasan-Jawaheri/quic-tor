...
class QuicSockClientSessionBase;
...
class NET_EXPORT_PRIVATE QuicSockClientCryptoStreamBase : public QuicCryptoStream {
 public:
  explicit QuicSockClientCryptoStreamBase(QuicSockClientSessionBase* session);

  ~QuicSockClientCryptoStreamBase() override{};
...
class NET_EXPORT_PRIVATE QuicSockClientCryptoStream
    : public QuicSockClientCryptoStreamBase {
 public:
  ...
  QuicSockClientCryptoStream(const QuicServerId& server_id,
                         QuicSockClientSessionBase* session,
                         ProofVerifyContext* verify_context,
                         QuicCryptoClientConfig* crypto_config);

  ~QuicSockClientCryptoStream() override;

  // From QuicSockClientCryptoStreamBase
 ...
 private:
  ...
  class ChannelIDSourceCallbackImpl : public ChannelIDSourceCallback {
   public:
    explicit ChannelIDSourceCallbackImpl(QuicSockClientCryptoStream* stream);
   ...
   private:
    QuicSockClientCryptoStream* stream_;
  };
  ...
  class ProofVerifierCallbackImpl : public ProofVerifierCallback {
   public:
    explicit ProofVerifierCallbackImpl(QuicSockClientCryptoStream* stream);
  ...
  QuicSockClientSessionBase* client_session();
  ...
  DISALLOW_COPY_AND_ASSIGN(QuicSockClientCryptoStream);
};
