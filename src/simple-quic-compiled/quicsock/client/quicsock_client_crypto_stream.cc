...
QuicSockClientCryptoStreamBase::QuicSockClientCryptoStreamBase(
    QuicSockClientSessionBase* session)
    : QuicCryptoStream(session) {}

QuicSockClientCryptoStream::ChannelIDSourceCallbackImpl::
    ChannelIDSourceCallbackImpl(QuicSockClientCryptoStream* stream)
    : stream_(stream) {}

QuicSockClientCryptoStream::ChannelIDSourceCallbackImpl::
    ~ChannelIDSourceCallbackImpl() {}

void QuicSockClientCryptoStream::ChannelIDSourceCallbackImpl::Run(
...
void QuicSockClientCryptoStream::ChannelIDSourceCallbackImpl::Cancel() {
  stream_ = nullptr;
}

QuicSockClientCryptoStream::ProofVerifierCallbackImpl::ProofVerifierCallbackImpl(
    QuicSockClientCryptoStream* stream)
    : stream_(stream) {}

QuicSockClientCryptoStream::ProofVerifierCallbackImpl::
    ~ProofVerifierCallbackImpl() {}

void QuicSockClientCryptoStream::ProofVerifierCallbackImpl::Run(
    bool ok,
...
void QuicSockClientCryptoStream::ProofVerifierCallbackImpl::Cancel() {
  stream_ = nullptr;
}

QuicSockClientCryptoStream::QuicSockClientCryptoStream(
    const QuicServerId& server_id,
    QuicSockClientSessionBase* session,
    ProofVerifyContext* verify_context,
    QuicCryptoClientConfig* crypto_config)
    : QuicSockClientCryptoStreamBase(session),
...
void QuicSockClientCryptoStream::OnHandshakeMessage(
    const CryptoHandshakeMessage& message) {
  QuicSockClientCryptoStreamBase::OnHandshakeMessage(message);
...
void QuicSockClientCryptoStream::CryptoConnect() {
  next_state_ = STATE_INITIALIZE;
  DoHandshakeLoop(nullptr);
}

int QuicSockClientCryptoStream::num_sent_client_hellos() const {
  return num_client_hellos_;
}

// Used in Chromium, but not in the server.
bool QuicSockClientCryptoStream::WasChannelIDSent() const {
  return channel_id_sent_;
}

bool QuicSockClientCryptoStream::WasChannelIDSourceCallbackRun() const {
  return channel_id_source_callback_run_;
}

void QuicSockClientCryptoStream::HandleServerConfigUpdateMessage(
...
void QuicSockClientCryptoStream::DoHandshakeLoop(const CryptoHandshakeMessage* in) {
  QuicCryptoClientConfig::CachedState* cached =
      crypto_config_->LookupOrCreate(server_id_);
...
void QuicSockClientCryptoStream::DoInitialize(
    QuicCryptoClientConfig::CachedState* cached) {
...
void QuicSockClientCryptoStream::DoSendCHLO(
    QuicCryptoClientConfig::CachedState* cached) {
...
void QuicSockClientCryptoStream::DoReceiveREJ(
...
QuicAsyncStatus QuicSockClientCryptoStream::DoVerifyProof(
    QuicCryptoClientConfig::CachedState* cached) {
...
void QuicSockClientCryptoStream::DoVerifyProofComplete(
    QuicCryptoClientConfig::CachedState* cached) {
  if (!verify_ok_) {
...
QuicAsyncStatus QuicSockClientCryptoStream::DoGetChannelID(
    QuicCryptoClientConfig::CachedState* cached) {
...
void QuicSockClientCryptoStream::DoGetChannelIDComplete() {
...
void QuicSockClientCryptoStream::DoReceiveSHLO(
    const CryptoHandshakeMessage* in,
    QuicCryptoClientConfig::CachedState* cached) {
  next_state_ = STATE_NONE;
...
void QuicSockClientCryptoStream::DoInitializeServerConfigUpdate(
    QuicCryptoClientConfig::CachedState* cached) {
...
void QuicSockClientCryptoStream::SetCachedProofValid(
    QuicCryptoClientConfig::CachedState* cached) {
  cached->SetProofValid();
  client_session()->OnProofValid(*cached);
}

bool QuicSockClientCryptoStream::RequiresChannelID(
    QuicCryptoClientConfig::CachedState* cached) {
...
QuicSockClientSessionBase* QuicSockClientCryptoStream::client_session() {
  return reinterpret_cast<QuicSockClientSessionBase*>(session());
}
