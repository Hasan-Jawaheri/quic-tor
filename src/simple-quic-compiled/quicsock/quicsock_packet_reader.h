...
#ifndef NET_TOOLS_QUIC_QUICSOCK_PACKET_READER_H_
#define NET_TOOLS_QUIC_QUICSOCK_PACKET_READER_H_
...
class QuicSockPacketReader {
 public:
  QuicSockPacketReader();

  virtual ~QuicSockPacketReader();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(QuicSockPacketReader);
};

}  // namespace tools
}  // namespace net

#endif  // NET_TOOLS_QUIC_QUICSOCK_PACKET_READER_H_
