...
#ifndef NET_QUIC_QUIC_CRYPTO_CLIENT_SIMPLE_STREAM_H_
#define NET_QUIC_QUIC_CRYPTO_CLIENT_SIMPLE_STREAM_H_
...
class QuicClientSimpleSessionBase;
...
class NET_EXPORT_PRIVATE QuicCryptoClientSimpleStreamBase : public QuicCryptoStream {
 public:
  explicit QuicCryptoClientSimpleStreamBase(QuicClientSimpleSessionBase* session);

  ~QuicCryptoClientSimpleStreamBase() override{};
...
class NET_EXPORT_PRIVATE QuicCryptoClientSimpleStream
    : public QuicCryptoClientSimpleStreamBase {
 public:
  ...
  QuicCryptoClientSimpleStream(const QuicServerId& server_id,
                         QuicClientSimpleSessionBase* session,
                         ProofVerifyContext* verify_context,
                         QuicCryptoClientConfig* crypto_config);

  ~QuicCryptoClientSimpleStream() override;

  // From QuicCryptoClientSimpleStreamBase
 ...
 private:
  ...
  class ChannelIDSourceCallbackImpl : public ChannelIDSourceCallback {
   public:
    explicit ChannelIDSourceCallbackImpl(QuicCryptoClientSimpleStream* stream);
   ...
   private:
    QuicCryptoClientSimpleStream* stream_;
  };
  ...
  class ProofVerifierCallbackImpl : public ProofVerifierCallback {
   public:
    explicit ProofVerifierCallbackImpl(QuicCryptoClientSimpleStream* stream);
  ...
  QuicClientSimpleSessionBase* client_session();
  ...
  DISALLOW_COPY_AND_ASSIGN(QuicCryptoClientSimpleStream);
};

}  // namespace net

#endif  // NET_QUIC_QUIC_CRYPTO_CLIENT_SIMPLE_STREAM_H_
